...
class CmsController extends Controller
{
    ...
    public function updateBrand(Request $request)
    {
        $data = $request->validate([
            ...
            'footer_logo_upload' => ['nullable', 'image', 'max:4096'],
        ...
        CmsContent::set('brand', [
            ...
            'footer_logo' => $this->storedAssetPath($request, 'footer_logo_upload', $data['footer_logo_path'] ?? config('cms.brand.footer_logo')),
